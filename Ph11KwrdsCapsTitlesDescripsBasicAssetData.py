__artifacts_v2__ = {
    ...
    'Ph11_3KwrdsCapsTitlesDescripsLikesBasicAsstDataGenPlayPsql': {
        ...
        'description': 'Parses basic asset record data from iOS18 GenPlay-Photos.sqlite for assets that have'
                       ' Keywords, Captions, Titles, Descriptions, Captions and Likes.'
                       ' (zAssetDes.ZLONGDESCRIPTION > 0) or (zAddAssetAttr.ZTITLE > 0) or'
                       ' (zAddAssetAttr.ZACCESSIBILITYDESCRIPTION > 0) or'
                       ' (zKeywrd.ZSHORTCUT > 0) or (zKeywrd.ZTITLE > 0) or'
...
@artifact_processor
def Ph11_3KwrdsCapsTitlesDescripsLikesBasicAsstDataGenPlayPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
    for source_path in files_found:
        source_path = str(source_path)
