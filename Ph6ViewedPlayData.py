__artifacts_v2__ = {
    ...
    'Ph6_3ViewandPlayDataGenPlayPsql': {
        ...
        'description': 'Parses basic asset row data from GenPlay-Photos.sqlite for assets with'
                       ' view and played data in versions 18. If the iOS version is greater than iOS 16.5'
                       ' last viewed date from ZADDITTIONALASSETATTRIBUTES table ZLASTVIEWEDDATE field'
                       ' will be included. The results for this script will contain'
                       ' one row per ZASSET table Z_PK value.',
        'author': 'Scott Koenig',
...
@artifact_processor
def Ph6_3ViewandPlayDataGenPlayPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
    for source_path in files_found:
        source_path = str(source_path)
